...
public class HiddenStringUtils {
    ...
    // String constants.
    private static final String SEQUENCE_HEADER = "" + ChatColor.UNDERLINE + ChatColor.MAGIC + ChatColor.UNDERLINE;
    private static final String SEQUENCE_FOOTER = "" + ChatColor.UNDERLINE + ChatColor.ITALIC + ChatColor.UNDERLINE;
